...
if __name__ == '__main__':
    ...
    rgb_src_img = cv.cvtColor(img_2_1,cv.COLOR_BGR2RGB)
    rgb_cvt_img = hist_equal(img_2_1)
    display_img(rgb_src_img,rgb_cvt_img)
    # img_2_3 = cv.imread('2_3.jpg')
    # rgb_src_img = cv.cvtColor(img_2_3,cv.COLOR_BGR2RGB)
    # rgb_cvt_img = hist_equal(img_2_3)
    # display_img(rgb_src_img,rgb_cvt_img)